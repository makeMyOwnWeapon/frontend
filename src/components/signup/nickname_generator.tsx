...
const NicknameGenerator: React.FC<NicknameGeneratorProps> = ({ onNicknameGenerated }) => {
  ...
  const generateNickname = () => {
    const prefixes = [
      ...
      "아기자기한", "유니크한", "마법의", "빛나는", "화려한", "멋스러운", "빛나는", "환상적인", "꿈같은",
      "화려한", "반짝이는", "신나는", "동화 속의", "무지개처럼", "행복한", "관능적인", "상상력 있는",
      "자유로운", "신선한", "활발한", "도전적인", "자신감 넘치는", "인상적인", "도발적인", "빠른", "즐거운",
      "희망적인", "진지한", "평화로운", "안전한", "힐링하는", "귀감 있는", "지혜로운", "친근한",
      "영감을 주는", "창조적인", "칭찬받는", "자아 다크고", "상쾌한", "고급스러운", "스타일리시한",
      "헌신적인", "진실한", "감동적인", "섬세한", "가슴 뭉클한", "긍정적인", "열정적인", "멋진",
      "희망찬", "신뢰할 수 있는", "가슴 따뜻한", "친절한", "존경받는", "감사한", "인기 있는"
  ];
    const suffixes = [
      ...
      "리버", "버니", "퀸", "마린", "토니", "블러썸", "로즈", "버터", "마시멜로", "버디", "로즈",
      "비비드", "바니", "카페", "케이크", "프라임", "리플렉트", "라이트", "메이플", "세이지", "데일리",
